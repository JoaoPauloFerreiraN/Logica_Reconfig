...
ARCHITECTURE structure OF circuito_somador IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Add0~1_combout\ = \a[1]~input_o\ $ (\b[1]~input_o\ $ (((\b[0]~input_o\ & \a[0]~input_o\))))
...
-- Equation(s):
-- \Add0~2_combout\ = (\a[1]~input_o\ & ((\b[1]~input_o\) # ((\b[0]~input_o\ & \a[0]~input_o\)))) # (!\a[1]~input_o\ & (\b[0]~input_o\ & (\a[0]~input_o\ & \b[1]~input_o\)))
